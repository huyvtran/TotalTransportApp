...
*/
@Injectable()
export class TaskRailwayServiceProvider {
  ...
  getTaskListByPage(queryParam, page, rows) {
    let url = AppConfig.getUrl() + '/app/taskRailway/getTaskListByPage.do';
    let params = {
  ...
  getAttachmentFileListByPage(taskId) {
    let url = AppConfig.getUrl() + '/app/taskRailway/getAttachmentFileListByPage.do';
    let params = {
      taskId: taskId
    };
    return new Promise((resolve, reject) => {
